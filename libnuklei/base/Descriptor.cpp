...
NUKLEI_SERIALIZATION_REGISTER_TYPE(nuklei::ColorPairDescriptor)
NUKLEI_SERIALIZATION_REGISTER_TYPE(nuklei::ColorDescriptor)
NUKLEI_SERIALIZATION_REGISTER_TYPE(nuklei::GraspDescriptor)
NUKLEI_SERIALIZATION_REGISTER_TYPE(nuklei::TwoFingerDescriptor)
NUKLEI_SERIALIZATION_REGISTER_TYPE(nuklei::PlaneDescriptor)
NUKLEI_SERIALIZATION_REGISTER_TYPE(nuklei::RGBColor)
NUKLEI_SERIALIZATION_REGISTER_TYPE(nuklei::HSVColor)
NUKLEI_SERIALIZATION_REGISTER_TYPE(nuklei::HSVConeColor)
